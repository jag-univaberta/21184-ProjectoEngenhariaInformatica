...
<DataContract()>
Public Enum pccMap4LayerType
    Null = 0
    Vector = 1
    Raster = 2
End Enum

Public Interface IPCCIMapServer
...
Public Interface IG10IMap
    ...
    Function GetObjectsIntersection(p_layername As String, p_selectgeometry As pccGeoGeometry, Optional contador As Integer = 0) As pccMapguide4Object()
    ...
    Property ZoomScaleDPI(ByVal p_center As pccBase4.pccGeoPoint, ByVal p_newscale As Long, ByVal p_imagewidth As Long, ByVal p_imageheight As Long, ByVal DPI As Long) As Byte()
    Property ZoomScaleDPI_url(ByVal p_center As pccBase4.pccGeoPoint, ByVal p_newscale As Long, ByVal p_imagewidth As Long, ByVal p_imageheight As Long, ByVal DPI As Long) As String
    Property LayerBaseShowHide(ByVal p_center As pccBase4.pccGeoPoint, ByVal p_newscale As Long, ByVal p_imagewidth As Long, ByVal p_imageheight As Long, ByVal DPI As Long, ByVal showgroups As String, ByVal hidegroups As String) As Byte()
    ...
    Property GetLayer(ByVal p_name As String) As pccMapguide4Layer

    Property GetGrupo(ByVal p_name As String) As pccMapguide4Group

    Property GetLayerBase(ByVal p_name As String) As pccMapguide4BaseLayer

    Property GetLayers() As pccMap4LayerSet
    Property GetLayersBase() As pccMap4BaseLayerSet
    Function GetLayersOn() As pccMap4LayerSet
    Function GetLayersWithVisibleObjects() As pccMap4LayerSet
    Property GetInitialView() As pccMap4View
    ...
    Sub Save()
    Sub SetInitialView(ByRef p_view As pccMap4View)
    Function GetActualView() As pccMap4View
    Sub SetActualView(ByVal p_view As pccMap4View)
    Sub Refresh()
    Function GetObjects(ByVal p_layername As String, ByVal p_selectgeometry As pccGeoGeometry, Optional ByVal contador As Integer = 0, Optional ByVal getAllProp As Boolean = True) As pccMapguide4Object()
    Function GetAllObjects(ByVal p_layername As String, Optional ByVal contador As Integer = 0, Optional ByVal getAllProp As Boolean = True) As pccMapguide4Object()
    ...
    Function GetObjectsLayersEx(ByVal p_selectgeometry As pccGeoGeometry, Optional ByVal listalayer As String = "", Optional ByVal getAllProp As Boolean = True) As pccMapguide4Object()

    Function GetObjectsEx(ByVal p_selectgeometry As pccGeoGeometry, Optional ByVal getAllProp As Boolean = True) As pccMapguide4Object()
    Function GetObjectOnTop(ByVal p_selectgeometry As pccGeoGeometry) As pccMapguide4Object
    Function GetSelectedObject(ByVal p_selectgeometry As pccGeoGeometry, ByRef conn As pccDB4.Connection, ByRef trans As IDbTransaction) As Boolean
    Function GetMapServer() As pccMapguide4Server
    ...
    Function RemoveLayer(ByVal layer As pccMapguide4Layer) As Boolean
...
Public Interface IG10IMapObject
    ...
    Property Layer() As pccMapguide4Layer
    Property Properties() As pccMap4ObjectProperty()
...
<DataContract()>
<KnownType(GetType(List(Of pccMapguide4Layer)))>
<KnownType(GetType(pccMapguide4Layer))>
Public Class pccMap4LayerSet
    Private _layers As List(Of pccMapguide4Layer)
    Private Shared ReadOnly _locker As New Object()
    Public Sub New()
        SyncLock _locker
            _layers = New List(Of pccMapguide4Layer)
        End SyncLock
    End Sub
    <DataMember()>
    Public Property Layers As List(Of pccMapguide4Layer)
        Get
            SyncLock _locker
                Return _layers
            End SyncLock
        End Get
        Set(ByVal value As List(Of pccMapguide4Layer))
            SyncLock _locker
                _layers = value
            End SyncLock
        End Set
...
<DataContract()>
<KnownType(GetType(List(Of pccMapguide4BaseLayer)))>
<KnownType(GetType(pccMapguide4BaseLayer))>
Public Class pccMap4BaseLayerSet
    Private _layers As List(Of pccMapguide4BaseLayer)
    Private Shared ReadOnly _locker As New Object()
    Public Sub New()
        SyncLock _locker
            _layers = New List(Of pccMapguide4BaseLayer)
        End SyncLock
    End Sub
    <DataMember()>
    Public Property Layers As List(Of pccMapguide4BaseLayer)
        Get
            SyncLock _locker
                Return _layers
            End SyncLock
        End Get
        Set(ByVal value As List(Of pccMapguide4BaseLayer))
            SyncLock _locker
                _layers = value
            End SyncLock
        End Set
...
Public Class pccMap4View
    ...
    Public Function GetCoordsImage2Map(ByRef p_coords_image As pccGeoPoint, ByRef m As pccMapguide4Map, ByVal p_imagewidth As Double, ByVal p_imageheight As Double) As pccGeoPoint
        SyncLock _locker
            ' cs of the map
    ...
    Public Function GetCoordsMap2Image(ByRef p_coords_map As pccGeoPoint, ByRef m As pccMapguide4Map, ByVal p_imagewidth As Double, ByVal p_imageheight As Double) As pccGeoPoint
        SyncLock _locker
            ' cs of the map
...
<DataContract()>
<Serializable()>
Public Class pccMap4ObjectType
            ...
            Select Case p_servertype
                ...
                Case pccMapServerType.MapGuideEnterprise
                    Select Case CType(p_type, Integer)
                        ...
                        Case Else
                            Throw New Exception("SRC: pccMap4ObjectType.New Invalid p_type")
                    End Select
...
<DataContract()>
<Serializable()>
Public Class pccMap4ObjectProperty

    Private _name As String
    Private _type As pccMap4ObjectType
    Private _value As Object
    Private Shared ReadOnly _locker As New Object()
    Public Sub New()
    End Sub

    Public Sub New(ByVal p_name As String, ByVal p_type As pccMap4ObjectType, ByVal p_value As Object)
        SyncLock _locker
            _name = p_name
            _type = p_type
            _value = p_value
    ...
    End Property
    <DataMember()>
    Public Property Type() As pccMap4ObjectType
        Get
            SyncLock _locker
                Return _type
            End SyncLock
        End Get
        Set(ByVal value As pccMap4ObjectType)
...
<DataContract()>
<Serializable()>
Public Class pccMapguide4Server
    Implements IPCCIMapServer
    ...
    Public Sub New(ByVal p_configFile As String, ByVal sessionId As String, ByVal AgentUrl As String)
        ...
        End SyncLock
    End Sub
    Public ReadOnly Property Message() As String Implements IPCCIMapServer.Message
        Get
            SyncLock _locker
                Return _message
            End SyncLock
    ...
    End Property
    <DataMember()>
    Public Property TestConnect() As Boolean Implements IPCCIMapServer.TestConnect
    ...
    Public ReadOnly Property SiteConnection() As Object Implements IPCCIMapServer.SiteConnection
        Get
            SyncLock _locker
    ...
    End Property
    <DataMember()>
    Public Property AgentURL() As String Implements IPCCIMapServer.AgentURL
    ...
    Public ReadOnly Property SessionID() As String Implements IPCCIMapServer.SessionID
        Get
            SyncLock _locker
                Return _sessionid
            End SyncLock
...
<KnownType(GetType(pccGeoCollection)), KnownType(GetType(pccGeoRectangle))>
<Serializable()>
Public Class pccMapguide4Map

    Implements IG10IMap

    Private _mapserver As pccMapguide4Server
    ...
    Private _actualview As pccMap4View
    Private _initialview As pccMap4View
    Private _layers As pccMap4LayerSet
    Private _layersbase As pccMap4BaseLayerSet
    Private _grupos As pccMap4GroupLayerSet
    ...
    Public Sub Save() Implements IG10IMap.Save
        _map.Save()
    End Sub
    Public Sub New(ByRef p_mapserver As pccMapguide4Server, ByVal p_mapdefinition As String, ByVal p_mapName As String, ByVal p_metriccs_wkt As String)
        SyncLock _locker
            Try
                ...
                _initialview = New pccMap4View(New pccGeoPoint(_map.GetViewCenter.Coordinate.GetX, _map.GetViewCenter.Coordinate.GetY), _map.GetViewScale, _map.GetDisplayDpi, _map.GetMapExtent.GetWidth, _map.GetMapExtent.GetHeight, _map.GetDisplayWidth, _map.GetDisplayHeight)
                ...
                _layersbase = New pccMap4BaseLayerSet
                _grupos = New pccMap4GroupLayerSet

                _grupobasenome = GetGruposBaseNome()
                _layersbasenome = GetLayersBaseNome()

                _layers = New pccMap4LayerSet
                _layersbase = New pccMap4BaseLayerSet

                For Each group As MgLayerGroup In _map.GetLayerGroups()
                    If InStr(_grupobasenome, "," + group.Name + ",") > 0 Then
                        Dim aux As New pccMapguide4BaseLayer(group)
                        _layersbase.Add(aux)
                    Else
                        Dim aux As New pccMapguide4Group(group)
                        _grupos.Add(aux)
                    End If
                Next
    ...
    Public Sub New(ByRef p_mapserver As IPCCIMapServer, ByVal p_mapName As String, ByVal p_metriccs_wkt As String)
        SyncLock _locker
            Try
    ...
    Public Property TestConnect() As Boolean
        ...
        End Get
        Set(ByVal value As Boolean)
            Throw New Exception("pcc by design: pccMap4guideMap.TestConnect() is a readonly property.")
        End Set
    End Property

    Public Function GetActualView() As pccMap4View Implements IG10IMap.GetActualView
        SyncLock _locker
            Return _actualview
        End SyncLock
    End Function

    Public Sub SetActualView(ByVal p_view As pccMap4View) Implements IG10IMap.SetActualView
        SyncLock _locker
            _actualview = p_view
        End SyncLock
    End Sub
    ...
    <DataMember()>
    Public Property GetInitialView() As pccMap4View Implements IG10IMap.GetInitialView
        Get
            SyncLock _locker
                Return _initialview
            End SyncLock
        End Get
        Set(ByVal value As pccMap4View)
    ...
    Public Function RemoveLayer(ByVal layer As pccMapguide4Layer) As Boolean Implements IG10IMap.RemoveLayer
        SyncLock _locker
            Dim layerscol As MgLayerCollection
            layerscol = _map.GetLayers()
    ...
    Public Sub SetInitialView(ByRef p_view As pccMap4View) Implements IG10IMap.SetInitialView
        SyncLock _locker
            _initialview = p_view
        End SyncLock
    End Sub
    ...
    Public Function GetObjects(ByVal p_layername As String, ByVal p_selectgeometry As pccBase4.pccGeoGeometry, Optional ByVal contador As Integer = 0, Optional ByVal getAllProp As Boolean = True) As pccMapguide4Object() Implements IG10IMap.GetObjects
        ...
        SyncLock _locker
            ...
            Try
                ...
                Dim l As pccMapguide4Layer = Me.GetLayer(p_layername)
                ...
                Else
                    ...
                    Dim label As String = ""
                    Dim csmapa As pccGeoMetadata4.mtdReferenceSystemInfo = Me.GetCoordinateSystem()
                    If csmapa.WKT <> CoordSyswkt Then
                        Try
                            ...
                            Dim rsorigem As New pccGeoMetadata4.mtdReferenceSystemInfo(CoordSyswkt, csforigem.CreateFromCode(codeorigem))
                            ...
                            Dim rsdestino As New pccGeoMetadata4.mtdReferenceSystemInfo(csmapa.WKT, csfdestino.CreateFromCode(codedestino))
                            ...
                            If ggg Then
                                ...
                                Dim ponto3 As pccBase4.pccGeoPoint = New pccGeoPoint(coordsrc.X, coordsrc.Y)
                    ...
                    Dim a_objects As pccMapguide4Object() = Nothing
                    ...
                    If features IsNot Nothing Then
                        ...
                        While features.ReadNext And Not sair
                            ...
                            a_objects(k_objects) = New pccMapguide4Object()

                            Dim k_prop As Integer = features.GetPropertyCount()
                            Dim a_prop As pccMap4ObjectProperty()
                            ...
                            If getAllProp Then
                                For j As Integer = 0 To k_prop - 1
                                    ...
                                    a_prop(j) = New pccMap4ObjectProperty(propName, New pccMap4ObjectType(pccMapServerType.MapGuideEnterprise, features.GetPropertyType(propName)), o_value)
    ...
    Public Function GetAllObjects(ByVal p_layername As String, Optional ByVal contador As Integer = 0, Optional ByVal getAllProp As Boolean = True) As pccMapguide4Object() Implements IG10IMap.GetAllObjects
    ...
    Public Function GetObjectsIntersection(ByVal p_layername As String, ByVal p_selectgeometry As pccBase4.pccGeoGeometry, Optional ByVal contador As Integer = 0) As pccMapguide4Object() Implements IG10IMap.GetObjectsIntersection
        SyncLock _locker
    ...
    Public Function SelectionByParametersQuery(ByVal p_layername As String, ByVal parametersexpression As String, Optional ByVal resetSelection As Boolean = True) As Boolean Implements IG10IMap.SelectionByParametersQuery
        SyncLock _locker
            ...
            Else
                If l.GetLayerType() = pccMap4LayerType.Raster Then
                    Return False
                Else
    ...
    Public Function SelectionBySpatialQuery(ByVal p_layername As String, ByVal p_selectgeometry As pccBase4.pccGeoGeometry, Optional ByVal resetSelection As Boolean = True) As Boolean Implements IG10IMap.SelectionBySpatialQuery
        SyncLock _locker
            Dim wktReaderWriter As MgWktReaderWriter = New MgWktReaderWriter()
            ...
            If l Is Nothing Or l.GetLayerType() = pccMap4LayerType.Raster Then
    ...
    Public Function GetObjectsLayersEx(ByVal p_selectgeometry As pccBase4.pccGeoGeometry, Optional ByVal listalayer As String = "", Optional ByVal getAllProp As Boolean = True) As pccMapguide4Object() Implements IG10IMap.GetObjectsLayersEx
        SyncLock _locker

            Try
                Dim layers As pccMap4LayerSet
                layers = Me.GetLayers()

                listalayer = "," & listalayer & ","

                Dim col As New Collection

                For Each l As pccMapguide4Layer In layers.Layers

                    If l.GetVisibility Then

                        If listalayer = ",," Or InStr(listalayer, "," & l.Name & ",") > 0 Then
                            If l.GetLayerType() <> pccMap4LayerType.Raster Then
                                Dim objs As pccMapguide4Object()
                                objs = GetObjects(l.Name, p_selectgeometry, 0, getAllProp)
                                If objs IsNot Nothing Then


                                    For Each obj As pccMapguide4Object In objs
                                        obj.Layer = l
                                        col.Add(obj)
                                    Next
                                Else
                ...
                Dim res As pccMapguide4Object()
                ReDim res(col.Count - 1)

                Dim i As Long = 0
                For Each obj As Object In col
                    res(i) = CType(obj, pccMapguide4Object)
                    i += 1
                Next
    ...
    Public Function GetObjectsEx(ByVal p_selectgeometry As pccBase4.pccGeoGeometry, Optional ByVal getAllProp As Boolean = True) As pccMapguide4Object() Implements IG10IMap.GetObjectsEx
        SyncLock _locker
    ...
    Public Function GetObjectOnTop(ByVal p_selectgeometry As pccBase4.pccGeoGeometry) As pccMapguide4Object Implements IG10IMap.GetObjectOnTop
        SyncLock _locker
            Try
                        ...
                        If objs IsNot Nothing Then
                            For Each obj As pccMapguide4Object In objs
                                ...
                                If obj.Name IsNot Nothing Then
                                    For Each pr As pccMap4ObjectProperty In obj.Properties
                ...
                If col.Count > 0 Then
                    Return CType(col.Item(1), pccMapguide4Object)
                Else
                    Return Nothing
                End If
            Catch ex As Exception
    ...
    Public Function GetSelectedObject(ByVal p_selectgeometry As pccBase4.pccGeoGeometry, ByRef conn As pccDB4.Connection, ByRef trans As IDbTransaction) As Boolean Implements IG10IMap.GetSelectedObject
        SyncLock _locker
            Try
    ...
    Public Function GetMapServer() As pccMapguide4Server Implements IG10IMap.GetMapServer
        SyncLock _locker
            Return _mapserver
        End SyncLock
    End Function
    ...
    <DataMember()>
    Public Property ZoomScaleDPI(ByVal p_center As pccBase4.pccGeoPoint, ByVal p_newscale As Long, ByVal p_imagewidth As Long, ByVal p_imageheight As Long, ByVal DPI As Long) As Byte() Implements IG10IMap.ZoomScaleDPI
        ...
        Get
            SyncLock _locker
                ...
                Try
                    ...
                    _actualview = New pccMap4View(New pccGeoPoint(p_center.X, p_center.Y), p_newscale, _map.GetDisplayDpi, _map.GetMapExtent.GetWidth, _map.GetMapExtent.GetHeight, p_imagewidth, p_imageheight)
                    ...
                    _actualview = New pccMap4View(New pccGeoPoint(p_center.X, p_center.Y), p_newscale, _map.GetDisplayDpi, mapwidth, mapheight, p_imagewidth, p_imageheight)
        ...
        Set(ByVal value As Byte())
            Throw New Exception("pcc by design: pccMap4guideMap.ZoomScale() is a readonly property.")
        End Set

    End Property

    Public Property ZoomScaleDPI_url(ByVal p_center As pccBase4.pccGeoPoint, ByVal p_newscale As Long, ByVal p_imagewidth As Long, ByVal p_imageheight As Long, ByVal DPI As Long) As String Implements IG10IMap.ZoomScaleDPI_url
        ...
        Set(ByVal value As String)
            Throw New Exception("pcc by design: pccMap4guideMap.ZoomScaleDPI_url() is a readonly property.")
        End Set

    End Property

    <DataMember()>
    Public Property ZoomScale(ByVal p_center As pccBase4.pccGeoPoint, ByVal p_newscale As Long, ByVal p_imagewidth As Long, ByVal p_imageheight As Long) As Byte() Implements IG10IMap.ZoomScale
    ...
    Public Property GetLegend(ByVal p_imagewidth As Long, ByVal p_imageheight As Long) As Byte() Implements IG10IMap.GetLegend
        ...
        End Get
        Set(ByVal value As Byte())
            Throw New Exception("pcc by design: pccMap4guideMap.GetLegend() is a readonly property.")
        End Set

    End Property

    <DataMember()>
    Public Property ZoomWindow(ByVal p_center As pccBase4.pccGeoPoint, ByVal p_mapwidth As Double, ByVal p_mapheight As Double, ByVal p_imagewidth As Long, ByVal p_imageheight As Long) As Byte() Implements pccMap4.IG10IMap.ZoomWindow
        ...
        End Get
        Set(ByVal value As Byte())
            Throw New Exception("pcc by design: pccMap4guideMap.ZoomWindow() is a readonly property.")
        End Set
    End Property

    <DataMember()>
    Public Property ZoomWindowBase64(ByVal p_center As pccBase4.pccGeoPoint, ByVal p_mapwidth As Double, ByVal p_mapheight As Double, ByVal p_imagewidth As Long, ByVal p_imageheight As Long) As String Implements pccMap4.IG10IMap.ZoomWindowBase64
        ...
        End Get
        Set(ByVal value As String)
            Throw New Exception("pcc by design: pccMap4guideMap.ZoomWindowBase64() is a readonly property.")
        End Set
    End Property

    <DataMember()>
    Public Property GetLayer(ByVal p_layername As String) As pccMapguide4Layer Implements IG10IMap.GetLayer
        Get
        ...
        Set(ByVal value As pccMapguide4Layer)
            Throw New Exception("pcc by design: pccMap4guideMap.GetLayer() is a readonly property.")
        End Set
    ...
    <DataMember()>
    Public Property GetGrupo(ByVal p_groupname As String) As pccMapguide4Group Implements IG10IMap.GetGrupo
        Get
        ...
        Set(ByVal value As pccMapguide4Group)
            Throw New Exception("pcc by design: pccMap4guideMap.GetGrupo() is a readonly property.")
        End Set
    ...
    <DataMember()>
    Public Property GetLayerBase(ByVal p_layername As String) As pccMapguide4BaseLayer Implements IG10IMap.GetLayerBase
        Get
        ...
        Set(ByVal value As pccMapguide4BaseLayer)
            Throw New Exception("pcc by design: pccMap4guideMap.GetLayerBase() is a readonly property.")
        End Set
    ...
    <DataMember()>
    Public Property LayerBaseShowHide(ByVal p_center As pccBase4.pccGeoPoint, ByVal p_newscale As Long, ByVal p_imagewidth As Long, ByVal p_imageheight As Long, ByVal DPI As Long, ByVal showgroups As String, ByVal hidegroups As String) As Byte() Implements IG10IMap.LayerBaseShowHide
        ...
        Set(ByVal value As Byte())
            Throw New Exception("pcc by design: pccMap4guideMap.LayerBaseShowHide() is a readonly property.")
        End Set
    ...
    Public Property SuportaSQL(ByVal p_layername As String) As Boolean Implements IG10IMap.SuportaSQL
        ...
        Set(ByVal value As Boolean)
            'TODO: throw error
            Throw New Exception("pcc by design: pccMapguide4Layer.SupportsSQL() is a readonly property.")
        End Set
    End Property
    <DataMember()>
    Public Property ObjectosCorrectos(ByVal p_layername As String) As Boolean Implements IG10IMap.ObjectosCorrectos
        ...
        Set(ByVal value As Boolean)
            'TODO: throw error
            Throw New Exception("pcc by design: pccMapguide4Layer.LeituraOk() is a readonly property.")
        End Set
    End Property
    ...
    ' TODO: testar
    Public Function GetLayersWithVisibleObjects() As pccMap4LayerSet Implements IG10IMap.GetLayersWithVisibleObjects
        SyncLock _locker
            Dim ls As New pccMap4LayerSet

            Dim av As New pccMap4View
            av = GetActualView()

            Dim rect As New pccBase4.pccGeoPolygon()
            rect.AddVertice(New pccBase4.pccGeoPoint(av.Center.X - av.MapWidth / 2, av.Center.Y - av.MapHeight / 2))
            rect.AddVertice(New pccBase4.pccGeoPoint(av.Center.X - av.MapWidth / 2, av.Center.Y + av.MapHeight / 2))
            rect.AddVertice(New pccBase4.pccGeoPoint(av.Center.X + av.MapWidth / 2, av.Center.Y + av.MapHeight / 2))
            rect.AddVertice(New pccBase4.pccGeoPoint(av.Center.X + av.MapWidth / 2, av.Center.Y - av.MapHeight / 2))
            rect.AddVertice(New pccBase4.pccGeoPoint(av.Center.X - av.MapWidth / 2, av.Center.Y - av.MapHeight / 2))

            Dim rect1 As New pccBase4.pccGeoPolygon()
            rect1.AddVertice(New pccBase4.pccGeoPoint(av.Center.X - av.MapWidth / 4, av.Center.Y - av.MapHeight / 4))
            rect1.AddVertice(New pccBase4.pccGeoPoint(av.Center.X - av.MapWidth / 4, av.Center.Y + av.MapHeight / 4))
            rect1.AddVertice(New pccBase4.pccGeoPoint(av.Center.X + av.MapWidth / 4, av.Center.Y + av.MapHeight / 4))
            rect1.AddVertice(New pccBase4.pccGeoPoint(av.Center.X + av.MapWidth / 4, av.Center.Y - av.MapHeight / 4))
            rect1.AddVertice(New pccBase4.pccGeoPoint(av.Center.X - av.MapWidth / 4, av.Center.Y - av.MapHeight / 4))
            ...
            For Each l As pccMapguide4Layer In GetLayers.Layers
        ...
        End SyncLock
    End Function
    Public Function GetLayersOn() As pccMap4LayerSet Implements IG10IMap.GetLayersOn
        SyncLock _locker
            Dim ls As New pccMap4LayerSet
    ...
    <DataMember()>
    Public Property GetLayers As pccMap4LayerSet Implements IG10IMap.GetLayers
        Get
            SyncLock _locker
                Return _layers
            End SyncLock
        End Get
        Set(ByVal value As pccMap4LayerSet)
            Throw New Exception("pcc by design: pccMap4guideMap.GetLayers() is a readonly property.")
        End Set
    End Property
    <DataMember()>
    Public Property GetLayersBase As pccMap4BaseLayerSet Implements IG10IMap.GetLayersBase
        Get
            SyncLock _locker
                Return _layersbase
            End SyncLock
        End Get
        Set(ByVal value As pccMap4BaseLayerSet)
            Throw New Exception("pcc by design: pccMap4guideMap.GetLayersBase() is a readonly property.")
        End Set
    End Property
    <DataMember()>
    Public Property ZoomScaleBase64(ByVal p_center As pccBase4.pccGeoPoint, ByVal p_newscale As Long, ByVal p_imagewidth As Long, ByVal p_imageheight As Long) As String Implements IG10IMap.ZoomScaleBase64
        Get
            SyncLock _locker
        ...
        End Get
        Set(ByVal value As String)
            Throw New Exception("pcc by design: pccMap4guideMap.ZoomScaleBase64() is a readonly property.")
        End Set
    End Property
    ...
    Public Function CreateCoordinateSystem(ByVal p_cswkt As String) As mtdReferenceSystemInfo Implements IG10IMap.CreateCoordinateSystem
        SyncLock _locker
            ...
            'Dim srs As String = _map.GetMapSRS() 
            Dim code As String = csf.ConvertWktToCoordinateSystemCode(p_cswkt) 'ETRS89.PT-TM06

            Dim epsgcode As String = csf.ConvertWktToEpsgCode(p_cswkt) '3763

            If code = "" Then
                code = "ETRS89.PT-TM06"
                p_cswkt = csf.ConvertCoordinateSystemCodeToWkt(code)
                epsgcode = csf.ConvertWktToEpsgCode(p_cswkt)
            End If
    ...
    Public Function Transform(ByRef p_geometry As pccBase4.pccGeoPoint, ByRef p_cssrc As mtdReferenceSystemInfo, ByRef p_csdst As mtdReferenceSystemInfo) As pccBase4.pccGeoPoint Implements IG10IMap.Transform
        SyncLock _locker
    ...
    Public Overrides Function GetHashCode() As Integer
        SyncLock _locker
            ...
            If Not (_layers Is Nothing) Then
                For Each l As pccMapguide4Layer In _layers.Layers
    ...
    End Function
    <DataMember()>
    Public Property GetExtent As pccBase4.pccGeoRectangle Implements IG10IMap.GetExtent
        Get
            SyncLock _locker
                Return _extent
            End SyncLock
        End Get
        Set(ByVal value As pccBase4.pccGeoRectangle)
            Throw New Exception("pcc by design: pccMap4guideMap.GetExtent() is a readonly property.")
        End Set
    End Property
    <DataMember()>
    Public Property GetExtentCenter As pccGeoPoint Implements IG10IMap.GetExtentCenter
        ...
        End Get
        Set(ByVal value As pccGeoPoint)
            Throw New Exception("pcc by design: pccMap4guideMap.GetExtentCenter() is a readonly property.")
        End Set
    End Property
    <DataMember()>
    Public Property ActualSelection As Object Implements IG10IMap.ActualSelection
        ...
        End Get
        Set(ByVal value As Object)
            Throw New Exception("pcc by design: pccMap4guideMap.ActualSelection() is a readonly property.")
        End Set
    End Property
...
<DataContract()>
<Serializable()>
Public Class pccMapguide4Layer
    ...
    Public Sub New(ByRef p_maplayer As Object)
        SyncLock _locker
            ...
            _group = New pccMapguide4Group(CType(_layer, MgLayer).GetGroup)
            '_base = New pccMapguide4Layer(CType(_layer, MgLayer).isbaselayer)
        End SyncLock
    End Sub
    ...
    Public Property Name() As String Implements IG10IMapLayer.Name
        ...
        Set(ByVal value As String)
            'TODO: throw error
            Throw New Exception("pcc by design: pccMapguide4Layer.Name() is a readonly property.")
        End Set
    End Property
    ...
    Public Property Id() As String Implements IG10IMapLayer.Id
        ...
        Set(ByVal value As String)
            'TODO: throw error
            Throw New Exception("pcc by design: pccMapguide4Layer.Id() is a readonly property.")
        End Set
    End Property
    ...
    Public Property LegendLabel() As String Implements IG10IMapLayer.LegendLabel
        ...
        Set(ByVal value As String)
            'TODO: throw error
            Throw New Exception("pcc by design: pccMapguide4Layer.LegendLabel() is a readonly property.")
        End Set
    End Property
    <DataMember()>
    Public Property GetVisibility() As Boolean Implements IG10IMapLayer.GetVisibility
        ...
        Set(ByVal value As Boolean)
            'TODO: throw error
            Throw New Exception("pcc by design: pccMapguide4Layer.GetVisibility() is a readonly property.")
        End Set
    End Property
    <DataMember()>
    Public Property IsVisible() As Boolean Implements IG10IMapLayer.IsVisible
        ...
        Set(ByVal value As Boolean)
            'TODO: throw error
            Throw New Exception("pcc by design: pccMapguide4Layer.IsVisible() is a readonly property.")
        End Set
    End Property
    <DataMember()>
    Public Property GetSelectable() As Boolean Implements IG10IMapLayer.GetSelectable
        ...
        Set(ByVal value As Boolean)
            'TODO: throw error
            Throw New Exception("pcc by design: pccMapguide4Layer.GetSelectable() is a readonly property.")
        End Set
    End Property
        ...
        Get
            SyncLock _locker
                ...
                If LCase(aux) = "image" Or LCase(aux) = "raster" Then
                    Return pccMap4LayerType.Raster
                Else
                    Return pccMap4LayerType.Vector
                End If
            End SyncLock
        End Get
        Set(ByVal value As Integer)
            'TODO: throw error
            Throw New Exception("pcc by design: pccMapguide4Layer.GetLayerType() is a readonly property.")
        End Set
    End Property
...
<DataContract()>
<Serializable()>
Public Class pccMapguide4BaseLayer
    ...
    Public Property Name() As String Implements IG10IMapBaseLayer.Name
        ...
        Set(ByVal value As String)
            'TODO: throw error
            Throw New Exception("pcc by design: pccMapguide4Group.Name() is a readonly property.")
        End Set
    ...
    Public Property Id() As String Implements IG10IMapBaseLayer.Id
        ...
        Set(ByVal value As String)
            'TODO: throw error
            Throw New Exception("pcc by design: pccMapguide4Group.Id() is a readonly property.")
        End Set
    End Property
    ...
    Public Property LegendLabel() As String Implements IG10IMapBaseLayer.LegendLabel
        ...
        Set(ByVal value As String)
            'TODO: throw error
            Throw New Exception("pcc by design: pccMapguide4Group.LegendLabel() is a readonly property.")
        End Set
    ...
    Public Property GetVisibility() As Boolean Implements IG10IMapBaseLayer.GetVisibility
        ...
        Set(ByVal value As Boolean)
            'TODO; throw error
            Throw New Exception("pcc by design: pccMapguide4Group.GetVisibility() is a readonly property.")
        End Set
    End Property
    <DataMember()>
    ...
    Public Property GetSelectable() As Boolean Implements IG10IMapBaseLayer.GetSelectable
        ...
        Set(ByVal value As Boolean)
            'TODO; throw error
            Throw New Exception("pcc by design: pccMapguide4Group.GetSelectable() is a readonly property.")
        End Set
    End Property
...
<DataContract()>
<Serializable()>
Public Class pccMapguide4Group
...
<DataContract()>
<KnownType(GetType(List(Of pccMapguide4Group)))>
<KnownType(GetType(pccMapguide4Group))>
Public Class pccMap4GroupLayerSet
    Private _layers As List(Of pccMapguide4Group)
    Private Shared ReadOnly _locker As New Object()
    Public Sub New()
        SyncLock _locker
            _layers = New List(Of pccMapguide4Group)
        End SyncLock
    End Sub
    <DataMember()>
    Public Property Layers As List(Of pccMapguide4Group)
        Get
            SyncLock _locker
                Return _layers
            End SyncLock
        End Get
        Set(ByVal value As List(Of pccMapguide4Group))
            SyncLock _locker
                _layers = value
            End SyncLock
        End Set
...
<KnownType(GetType(pccMap4ObjectProperty))>
<Serializable()>
Public Class pccMapguide4Object
    ...
    Private _layer As pccMapguide4Layer
    Private _geom As pccGeoGeometry
    Private _properties As pccMap4ObjectProperty()
    Private Shared ReadOnly _locker As New Object()
    ...
    End Sub
    <DataMember()>
    Public Property Layer() As pccMapguide4Layer Implements IG10IMapObject.Layer
    ...
    End Property
    <DataMember()>
    Public Property Properties() As pccMap4ObjectProperty() Implements IG10IMapObject.Properties
        ...
        Set(ByVal value As pccMap4ObjectProperty())
            SyncLock _locker
                _properties = value
            End SyncLock
        End Set
    ...
    End Property
    <DataMember()>
    Public Property Geom() As pccBase4.pccGeoGeometry Implements IG10IMapObject.Geom
        ...
        Set(ByVal value As pccBase4.pccGeoGeometry)
            SyncLock _locker
                _geom = value
            End SyncLock
        End Set
