...
Namespace Entities
    ...
    Public Class LightWeightPolyline
        ...
        Private Const m_TYPE As EntityType = EntityType.LightWeightPolyline
        Private m_vertexes As List(Of LightWeightPolylineVertex)
        ...
        Public Sub New(ByVal vertexes As List(Of LightWeightPolylineVertex), ByVal isClosed As Boolean)
            MyBase.New(DxfObjectCode.LightWeightPolyline)
            SyncLock _locker
        ...
        ''' </summary>
        ''' <param name="vertexes">Polyline <see cref="LightWeightPolylineVertex">vertex</see> list in object coordinates.</param>
        Public Sub New(ByVal vertexes As List(Of LightWeightPolylineVertex))
        ...
        Public Sub New()
            MyBase.New(DxfObjectCode.LightWeightPolyline)
            SyncLock _locker
                Me.m_vertexes = New List(Of LightWeightPolylineVertex)()
                Me.m_isClosed = False
                Me.m_layer = Layer.[Default]
                Me.m_color = AciColor.ByLayer
                Me.m_lineType = LineType.ByLayer
        ...
        ''' </summary>
        Public Property Vertexes() As List(Of LightWeightPolylineVertex)
            Get
                SyncLock _locker
                    Return Me.m_vertexes
                End SyncLock
            End Get
            Set(ByVal value As List(Of LightWeightPolylineVertex))
                SyncLock _locker
        ...
        ''' </summary>
        Public ReadOnly Property Type() As EntityType Implements IPolyline.Type
            Get
                SyncLock _locker
                    Return m_TYPE
                End SyncLock
        ...
        ''' </summary>
        Public Property Color() As AciColor Implements IPolyline.Color
            Get
                SyncLock _locker
                    Return Me.m_color
                End SyncLock
        ...
        ''' </summary>
        Public Property Layer() As Layer Implements IPolyline.Layer
            Get
                SyncLock _locker
                    Return Me.m_layer
                End SyncLock
        ...
        ''' </summary>
        Public Property LineType() As LineType Implements IPolyline.LineType
            Get
                SyncLock _locker
        ...
        ''' </summary>
        Public Property XData() As Dictionary(Of ApplicationRegistry, XData) Implements IPolyline.XData
            Get
                SyncLock _locker
                    Return Me.m_xData
                End SyncLock
        ...
        Public Sub SetConstantWidth(ByVal width As Single)
            SyncLock _locker
                For Each v As LightWeightPolylineVertex In Me.m_vertexes
        ...
        Public Function ToPolyline() As Polyline
            SyncLock _locker
                Dim polyVertexes As New List(Of PolylineVertex)()

                For Each v As LightWeightPolylineVertex In Me.m_vertexes
                    polyVertexes.Add(New PolylineVertex(v.Location) With { _
                     .BeginThickness = v.BeginThickness, _
                     .Bulge = v.Bulge, _
                     .Color = Me.Color, _
                     .EndThickness = v.EndThickness, _
                     .Layer = Me.Layer, _
                     .LineType = Me.LineType _
                    })
                Next

                Return New Polyline(polyVertexes, Me.m_isClosed) With { _
                 .Color = Me.m_color, _
                 .Layer = Me.m_layer, _
        ...
        Public Function PoligonalVertexes(ByVal bulgePrecision As Integer, ByVal weldThreshold As Single, ByVal bulgeThreshold As Single) As List(Of Vector2f)
            SyncLock _locker
                ...
                For Each vertex As LightWeightPolylineVertex In Me.Vertexes
