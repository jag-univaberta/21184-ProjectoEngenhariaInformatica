...
Namespace Entities
    ...
    Public Class Polyline3dVertex
        ...
        Protected Const m_TYPE As EntityType = EntityType.Polyline3dVertex
        ...
        Public Sub New()
            ...
            SyncLock _locker
                Me.m_flags = VertexTypeFlags.Polyline3dVertex
        ...
        ''' <summary>
        ''' Gets or sets the vertex <see cref="pccDXF4.Vector3f">location</see>.
        ''' </summary>
