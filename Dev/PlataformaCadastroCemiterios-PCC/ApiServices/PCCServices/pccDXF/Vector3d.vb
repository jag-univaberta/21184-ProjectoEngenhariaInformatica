...
Public Structure Vector3d
    ...
    ''' Unit X vector.
    ''' </summary>
    Public Shared ReadOnly Property UnitX() As Vector3d
        Get
    ...
    ''' Unit Y vector.
    ''' </summary>
    Public Shared ReadOnly Property UnitY() As Vector3d
        Get
    ...
    ''' Unit Z vector.
    ''' </summary>
    Public Shared ReadOnly Property UnitZ() As Vector3d
        Get
    ...
    Public Shared Function DotProduct(ByVal u As Vector3d, ByVal v As Vector3d) As Double
    ...
    Public Shared Function CrossProduct(ByVal u As Vector3d, ByVal v As Vector3d) As Vector3d

        Dim a As Double = u.Y * v.Z - u.Z * v.Y
        Dim b As Double = u.Z * v.X - u.X * v.Z
        Dim c As Double = u.X * v.Y - u.Y * v.X
    ...
    Public Shared Function Distance(ByVal u As Vector3d, ByVal v As Vector3d) As Double
    ...
    Public Shared Function SquareDistance(ByVal u As Vector3d, ByVal v As Vector3d) As Double
    ...
    Public Shared Function AngleBetween(ByVal u As Vector3d, ByVal v As Vector3d) As Double
    ...
    ''' <param name="v">Vector3d.</param>
    ''' <returns>Vector3d.</returns>
    Public Shared Function MidPoint(ByVal u As Vector3d, ByVal v As Vector3d) As Vector3d
    ...
    Public Shared Function ArePerpendicular(ByVal u As Vector3d, ByVal v As Vector3d, ByVal threshold As Double) As Boolean
    ...
    Public Shared Function AreParallel(ByVal u As Vector3d, ByVal v As Vector3d, ByVal threshold As Double) As Boolean
    ...
    ''' <returns>Vector3d.</returns>
    Public Shared Function Round(ByVal u As Vector3d, ByVal numDigits As Integer) As Vector3d
    ...
    Public Shared Narrowing Operator CType(ByVal u As Vector3d) As Vector3f

        Return New Vector3f(CSng(u.X), CSng(u.Y), CSng(u.Z))

    End Operator

    Public Shared Operator =(ByVal u As Vector3d, ByVal v As Vector3d) As Boolean
    ...
    Public Shared Operator +(ByVal u As Vector3d, ByVal v As Vector3d) As Vector3d
    ...
    Public Shared Operator -(ByVal u As Vector3d) As Vector3d

        Return New Vector3d(-u.X, -u.Y, -u.Z)

    End Operator

    Public Shared Operator *(ByVal u As Vector3d, ByVal a As Double) As Vector3d

        Return New Vector3d(u.X * a, u.Y * a, u.Z * a)

    End Operator

    Public Shared Operator *(ByVal a As Double, ByVal u As Vector3d) As Vector3d
    ...
    Public Function ToArray() As Double()
        ...
        Dim u As Double() = New Double() {Me.X, Me.Y, Me.Z}
        Return u
    ...
    Public Overloads Function Equals(ByVal obj As Vector3d, ByVal threshold As Double) As Boolean
    ...
    Public Overloads Function Equals(ByVal obj As Vector3d) As Boolean
    ...
    Public Overrides Function Equals(ByVal obj As Object) As Boolean
        ...
        If TypeOf obj Is Vector3d Then
            Return Me.Equals(CType(obj, Vector3d))
        End If
        Return False
