...
''' </summary>
Public Structure Matrix3f


    Private mM11 As Single
    Private mM12 As Single
    Private mM13 As Single
    Private mM21 As Single
    Private mM22 As Single
    Private mM23 As Single
    Private mM31 As Single
    Private mM32 As Single
    Private mM33 As Single
    ...
    Public Sub New(ByVal m11 As Single, ByVal m12 As Single, ByVal m13 As Single, ByVal m21 As Single, ByVal m22 As Single, ByVal m23 As Single, _
     ByVal m31 As Single, ByVal m32 As Single, ByVal m33 As Single)
    ...
    ''' </summary>
    Public Shared ReadOnly Property Zero() As Matrix3f
        Get

            Return New Matrix3f(0, 0, 0, 0, 0, 0, _
             0, 0, 0)
    ...
    ''' </summary>
    Public Shared ReadOnly Property Identity() As Matrix3f
        Get

            Return New Matrix3f(1, 0, 0, 0, 1, 0, _
             0, 0, 1)
    ...
    Public Shared Operator +(ByVal a As Matrix3f, ByVal b As Matrix3f) As Matrix3f

        Return New Matrix3f(a.M11 + b.M11, a.M12 + b.M12, a.M13 + b.M13, a.M21 + b.M21, a.M22 + b.M22, a.M23 + b.M23, _
    ...
    Public Shared Operator *(ByVal a As Matrix3f, ByVal b As Matrix3f) As Matrix3f
        ...
        Return New Matrix3f(a.M11 * b.M11 + a.M12 * b.M21 + a.M13 * b.M31, a.M11 * b.M12 + a.M12 * b.M22 + a.M13 * b.M32, a.M11 * b.M13 + a.M12 * b.M23 + a.M13 * b.M33, a.M21 * b.M11 + a.M22 * b.M21 + a.M23 * b.M31, a.M21 * b.M12 + a.M22 * b.M22 + a.M23 * b.M32, a.M21 * b.M13 + a.M22 * b.M23 + a.M23 * b.M33, _
    ...
    ''' <returns>Matrix3f.</returns>
    Public Shared Operator *(ByVal a As Matrix3f, ByVal u As Vector3f) As Vector3f
    ...
    ''' <returns>Matrix3f.</returns>
    Public Shared Operator *(ByVal m As Matrix3f, ByVal a As Single) As Matrix3f

        Return New Matrix3f(m.M11 * a, m.M12 * a, m.M13 * a, m.M21 * a, m.M22 * a, m.M23 * a, _
    ...
    Public Function Inverse() As Matrix3f

        Dim det As Single = Me.Determinant()
        Dim resultado = New Matrix3f()
        If det = 0 Then
    ...
    Public Function Traspose() As Matrix3f

        Return New Matrix3f(Me.mM11, Me.mM21, Me.mM31, Me.mM12, Me.mM22, Me.mM32, _
