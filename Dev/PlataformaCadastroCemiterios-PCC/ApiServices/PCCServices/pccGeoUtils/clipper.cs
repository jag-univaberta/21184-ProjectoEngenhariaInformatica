...
namespace Clipper
{
    ...
    [Flags]
    enum TOrientationFlag
    {
        ofEmpty = 0, ofClockwise = 1, ofCW = 2,
    ...
    internal class SkipList<T>
    {
        ...
        public T PopFirst()
        {
            ...
            if (delNode.next[0] != null)
                delNode.next[0].prev = m_Base;
            else m_Base.prev = m_Base;
            delNode = null;
            m_Count--;
            return result;
        }
