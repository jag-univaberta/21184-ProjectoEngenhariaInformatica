...
class AtendimentoGeral extends Component {
  constructor(props) {
    super(props);
  ...
  reder() {
    return (
      <form className="pccwindow_form">
        ...
        <table class="pccwindow_tabela pccwindow_detalhe">
        {this.state.data && ( <tr><td class="pccwindow_detalhe_c1" > </td><td>{this.state.data.observacoes}</td></tr> )}
        </table> 
      </form>
    );
  }
...
export default AtendimentoGeral;