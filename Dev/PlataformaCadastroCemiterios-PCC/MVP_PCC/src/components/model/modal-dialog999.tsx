...
export interface IRndModalDialogG999Props {
    x: number;
    y: number;
    width: number;
    height: number;
    ...
    icon?: IconName;
    onClose?: () => void;
    handleDialogPositionChange?: () => void;
...
export const RndModalDialogG999 = (props: IRndModalDialogG999Props) => {
    ...
    const ZINDEX = {
        zIndex: 10000001 //So flyouts will appear above it
    };
    ...
    /*const MoveWindow= (x: number,y: number) => dispatch({
        type: Actions.UPDATE_WINDOW,
        payload: { posicao_x: x,
            posicao_y: y }});
    const onMoveWindow = (x: number,y : number) => MoveWindow(x,y);*/
...
export default RndModalDialogG999;