...
import { isMenuRef, isComponentFlyout } from "mapguide-react-layout/lib/utils/type-guards";
import { IDOMElementMetrics, FlyoutVisibilitySet, GenericEvent } from "mapguide-react-layout/lib/api/common";
import { ToolbarContext } from "mapguide-react-layout/lib/components/context";
import { STR_EMPTY } from "mapguide-react-layout/lib/utils/string";
import { ImageIcon } from "mapguide-react-layout/lib/components/icon";
import {
    BlueprintSvgIconNames
} from "mapguide-react-layout/lib/constants/assets";
import { Icon } from '@blueprintjs/core';
import { NBSP } from 'mapguide-react-layout/lib/constants';

export const DEFAULT_TOOLBAR_SIZE = 30;
 ...
 * @param props 
 */
export const ToolbarGISComponent = (props: IToolbarProps) => {
    const {
        containerStyle,
        containerClass,
        childItems,
