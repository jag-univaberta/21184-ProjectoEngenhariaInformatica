...
import { ILayerInfo, Bounds, LayerProperty, IMapViewer } from "mapguide-react-layout/lib/api/common";
import { ManageLayers } from "mapguide-react-layout/lib/components/layer-manager/manage-layers";
import { AddLayer } from "mapguide-react-layout/lib/components/layer-manager/add-layer";
import { Tabs, Tab, Icon } from '@blueprintjs/core';
import { useViewerLocale, useActiveMapName, useActiveMapLayers, useActiveMapView } from 'mapguide-react-layout/lib/containers/hooks';
import olVectorLayer from "ol/layer/Vector";
import olClusterSource from "ol/source/Cluster";
import { transformExtent } from "ol/proj";
import { mapLayerAdded, addMapLayerBusyWorker, removeMapLayerBusyWorker, removeMapLayer, setMapLayerIndex, setMapLayerVisibility, setMapLayerOpacity, setMapLayerVectorStyle, setHeatmapLayerBlur, setHeatmapLayerRadius } from 'mapguide-react-layout/lib/actions/map';
import { getViewer } from 'mapguide-react-layout/lib/api/runtime';
import { IVectorLayerStyle, VectorStyleSource } from 'mapguide-react-layout/lib/api/ol-style-contracts';
...
export const Container_AddManageLayersContainer = () => {
